...
from tests.test_pyshex.utils.setup_test import EX, gen_rdf, setup_context
...
class NumericFacetTestCase(unittest.TestCase):
    ...
    def test_example_1(self):
        ...
        self.assertEqual(['Numeric value violation - minimum inclusive: 1.0 actual: 0'], self.fail_reasons(cntxt))
